...
cc2_lg
cc2_circ
unique(c(ph1_lg, ph1_circ, pm_lg, pm_circ, cc_circ, cc1_lg, cc1_circ, cc2_lg, cc2_circ))
...
DotPlot(blood.combined_flt, group.by = 'anno_simple_v2', split.by = 'origin', 
        features = unique(rev(
          c(origin_lg, origin_circ,
            ...
            pm_lg, pm_circ,
            cc1_lg, cc1_circ,
            cc2_lg, cc2_circ, '14-3-3zeta')
        )), 
        dot.scale = 3, cols = c('#fd9409', '#69b9c2')) + 
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = .5))
#ggsave('intersect_genes_20200504.pdf', units = 'cm', width = 25, height = 12)
...
DotPlot(subset(blood.combined_flt, idents = 'LG'), 
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = .5))
#ggsave('intersect_genes_LG_20200504.pdf', units = 'cm', width = 25, height = 12)
...
DotPlot(subset(blood.combined_flt, idents = 'Circ'), 
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = .5))
#ggsave('intersect_genes_Circ_20200504.pdf', units = 'cm', width = 25, height = 12)
