...
lymphgland <- subset(lymphgland, idents = 'AEL96hr')
...
#write.table(intersect(VariableFeatures(lymphgland), filtergenes), 'filteredgenes_96hAEL.txt', quote = F, sep = '\n', row.names = F, col.names = F)
...
### 1. Determine PCs ###
lymphgland <- calc_pcs(lymphgland, './') # 26 PCs
