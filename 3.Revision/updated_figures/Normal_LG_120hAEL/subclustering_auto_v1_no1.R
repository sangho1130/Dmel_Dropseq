...
lymphgland <- subset(lymphgland, idents = 'AEL120hr')
...
#write.table(intersect(VariableFeatures(lymphgland), filtergenes), 'filteredgenes_120hAEL.txt', quote = F, sep = '\n', row.names = F, col.names = F)
...
### 1. Determine PCs ###
lymphgland <- calc_pcs(lymphgland, './') # 32 PCs
