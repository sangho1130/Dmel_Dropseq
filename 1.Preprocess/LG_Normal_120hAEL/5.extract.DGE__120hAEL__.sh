...
### 120 h AEL lib4 ###
/home/sangho/programs/src/Drop-seq_tools-1.13/DigitalExpression I=lib4/error_detected.bam O=lib4/error_detected.expr.txt SUMMARY=lib4/error_detected.summary.txt MIN_NUM_READS_PER_CELL=5000
